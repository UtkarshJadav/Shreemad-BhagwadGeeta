...
package com.utkarsh.revisecode.utils.extention
...
import com.utkarsh.revisecode.common.WEATHER_DATE_FORMAT
...
fun Calendar.getWeatherDateFormat(dateFormat: String = WEATHER_DATE_FORMAT): String {
    val format: DateFormat = SimpleDateFormat(dateFormat, Locale.getDefault())
    return format.format(this.time)
}

fun String.getCalender(dateFormat: String = "yyyy-MM-dd"): Calendar {
