...
import com.utkarsh.revisecode.common.base.BaseAdapter
import com.utkarsh.revisecode.R
import com.utkarsh.revisecode.data.remote.ApiResponse
import com.utkarsh.revisecode.utils.common.Results
...
fun <T> ApiResponse<T>?.handleApiView(
    ...
    isDisplaySuccessMessage: Boolean = false,
    isSuccess: (t: T?) -> Unit = {}
) {
    when (this) {
        ...
        is ApiResponse.Success -> {
            if (isDisplaySuccessMessage) {
                (data as? Results<*>)?.extraMeta?.message?.let {
