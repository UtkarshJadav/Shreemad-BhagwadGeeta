...
import com.farmit.utils.common.CustomTypefaceSpan
...
infix fun SpannableString.concat(s: CharSequence): SpannableStringBuilder =
    SpannableStringBuilder().append(this).append(s)
